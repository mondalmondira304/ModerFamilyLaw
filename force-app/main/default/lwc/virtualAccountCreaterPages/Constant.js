    ...
    DATA_CONFIG:{
        ...
        Housing__r: {
            fields: ['Housing__c.Id', 'Housing__c.Name', 'Housing__c.Joint__c',
                'Housing__c.Home_Equity_Estimate__c', 'Housing__c.Property_City__c','Housing__c.Property_Titled__c','Housing__c.Client_Estimate_of_Value__c'],
        ...
        Life_Insurance__r: {    
            fields: ['Life_Insurance__c.Id', 'Life_Insurance__c.Name', 'Life_Insurance__c.Type_of_Policy__c',
                ...
                'Life_Insurance__c.Life_Insurance_Joint__c', 'Life_Insurance__c.Cash_Value_Today__c', 'Life_Insurance__c.Policy_Owner__c'],  //6/19 Don Martin
        ...
        Bank_Investment_Accounts__r: {
            fields: ['Bank_Account__c.Id', 'Bank_Account__c.Name', 'Bank_Account__c.Name_of_Bank__c',
                ...
                'Bank_Account__c.Account_Number_Last_4__c','Bank_Account__c.Account_Balance__c'],
        ...
        Investment_Account__r: {
            fields: ['Investment_Account__c.Id', 'Investment_Account__c.Name', 'Investment_Account__c.TYPE_OF_ACCOUNT__c','Investment_Account__c.ACCOUNT_NUMBER_LAST_4__c',
                'Investment_Account__c.NAME_OF_BANK__c', 'Investment_Account__c.MARITAL_OR_SEPARATE__c', 'Investment_Account__c.ACCOUNT_BALANCE__c'],
        ...
        Retirement_Accounts__r: {
            fields: ['Retirement_Account__c.Id', 'Retirement_Account__c.Name', 'Retirement_Account__c.Name_of_Retirement_Bank__c','Retirement_Account__c.Account_Number_Last_4__c',
                'Retirement_Account__c.Type_of_Retirement_Account__c', 'Retirement_Account__c.Marital_or_Separate__c','Retirement_Account__c.Current_Balance__c'],          
            columns: [
                {
                    type: 'button',
        ...
        Employment__r: {
            fields: ['Employment__c.Id', 'Employment__c.Name', 'Employment__c.Length_of_Employment__c', 'Employment__c.Job_Title__c','Employment__c.Date_of_Hire__c',
                'Employment__c.Monthly_Gross_Income__c','Employment__c.Date_Employment_Ended__c','Employment__c.Employer__c'],
        ...
        Taxes__r: {
            fields: ['Taxes__c.Id', 'Taxes__c.Name', 'Taxes__c.Year__c',
                'Taxes__c.IRS_Form__c','Taxes__c.Filing_Status__c','Taxes__c.Taxable_Income__c'],
        ...
        Credit_Card__r: {
            fields: ['Credit_Card__c.Id', 'Credit_Card__c.Name', 'Credit_Card__c.Marital_or_Separate__c', 'Credit_Card__c.Credit_Card_Number_Last_4__c',
        ...
        Debts__r: {
            fields: ['Debt__c.Id', 'Debt__c.Name', 'Debt__c.Marital_or_Separate_Property__c',
                'Debt__c.Type__c','Debt__c.Balance__c','Debt__c.Monthly_Payment__c','Debt__c.Account_Number_Last_4__c'],
        ...
        // -------------------- Expense Tab Section Start ----------------- ----------
        Matter__r: {
            fields: ['Matters__c.Id', 'Matters__c.Name'],
        },
